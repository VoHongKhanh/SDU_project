...
class VnBase
{
    ...
    public static function RandomString($length, $type = VnBase::VnMixed, $duplicateChecking = VnBase::VnFalse) {
        ...
        //echo "$tType # $result # ".($tType == VnBase::VnNonZeroDigit && $result[0] == '0')."<br/>";
    	if ($tType == VnBase::VnNonZeroDigit && $result[0] == '0') {
    ...
    /**
      * @method        VnLower Convert Vietnamese text to lower case.
      * @param  string $source Source string.
      * @return string         Lower case Vietnamese text.
      */
    public static function VnLower($source) {
        return mb_strtolower($source);
    }

    /**
      * @method        VnUpper Convert Vietnamese text to upper case.
      * @param  string $source Source string.
      * @return string         Upper case Vietnamese text.
      */
    public static function VnUpper($source) {
        return mb_strtoupper($source);
    }
}